 ...
 * @author 9a1ng
 */
@WebServlet(name = "ChuDeControl", urlPatterns = {"/chude"})
public class ChuDeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String mcd = request.getParameter("idcd");
        SachDAO sdao = new SachDAO();
        List<sach> listcd = sdao.findByIdCd(mcd);
        ...
        request.setAttribute("listS", listcd);
