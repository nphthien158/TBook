...
<div class="w3layoutscontaineragileits">
    <div class="container">
        <form action="newuser" style="min-width: 300px;" method="post">
            <h5 class="text-center"><label>Create User Information</label></h5>
            <div class="user">
            ...
            <div class="user ">
                ...
                <input class="form-control " type="text" name="taikhoan" value="${x.taikhoan}" placeholder="User Name....." />
            </div> <div class="user ">
                <label class="form-label">Password</label>
                <input class="form-control " type="password" name="matkhau" value="${x.matkhau}" placeholder="Password....." />
            </div>
            ...
            <br>
                    <div class="form-sub-w3ls user">
                        <label class="radiobutton"><input id="radnam" value="1" name ="role" checked="${x.vaitro==true?"checked":""}" type="radio">Admin</label>
                        <label class="radiobutton"><input id="radnu" value="0" name ="role" ${x.vaitro==false?"checked":""} type="radio">Khách</label>
                    </div>
